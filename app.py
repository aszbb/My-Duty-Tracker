...
st.write("Rozana ki timing enter karein, data automatic save rahega.")
...
# File path to save data permanently
...
with st.form("duty_form"):
  ...
  with col1:
    in_time_str = st.text_input("Aane ka Waqt (In Time)", value="08:16 AM")
  with col2:
    out_time_str = st.text_input("Jane ka Waqt (Out Time)", value="05:50 PM")
...
if submit_btn:
  try:
    ...
    if dt_out <= dt_in:
      ...
      # Purani list se is date ka record hata kar naya add karein (taake duplicate na ho)
      current_history = [
